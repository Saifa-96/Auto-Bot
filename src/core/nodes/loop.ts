import { Conditionals, SettingsHandler, isOrConditional } from "./base";
...
const getUsedImages = (data: LoopSettings): string[] => {
...
export const LoopSettingsHandler: SettingsHandler<LoopSettings> = {
  new: () => ({ conditionals: [] }),
  getUsedImages,
};
